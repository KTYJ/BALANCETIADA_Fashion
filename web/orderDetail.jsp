                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <div class="cart_btn">
                                <li><a href="cart.jsp"><ion-icon name="bag-handle-outline" style="font-size: 20px; vertical-align: text-top;"></ion-icon> CART (0)</a></li>
                            </div>
                            <div class="login_btn">
                                <li class="dropdown">
    ...
    <!-- ** Header Area End ** -->
        ...
        <%
            ...
            if (order != null) {
                ...
                double subtotal = productTotal + shippingFee;
                        ...
                        <table class="table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><strong>RM <%=String.format("%.2f", productTotal)%></strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="text-success">
                                    ...
                                    <td><strong>- RM <%=String.format("%.2f", discount)%></strong></td>
                                </tr>
                                <tr class="table-primary">
                                    <td colspan="5" class="text-end"><strong>Total:</strong></td>
                                    <td><strong>RM <%=String.format("%.2f", order.getTotal())%></strong></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
