...
public class OrdersDA {
    ...
    public Orders getOrderByOrderId(String orderId) throws SQLException, ClassNotFoundException {
    ...
    public Orders getOrderByCustOrderId(String orderId, String custId) throws SQLException, ClassNotFoundException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        Orders order = null;
    ...
    // get all orders
    public Orders getAllOrder() throws SQLException, ClassNotFoundException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        Orders order = null;
